...
urlpatterns = [
    ...
    path('/brands/<:brand_id>/cars/<:model_id>', views.model_detail, name = 'model_detail'), # see a specific car for a specific car brand
    path('/brands/<:brand_id>/cars/<:model_id>/edit', views.model_edit, name = 'model_edit'), # edit page for a specific car under a specific car brand   
]